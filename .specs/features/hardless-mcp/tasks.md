...
- [x] 1. Foundation do pacote `@hardless/mcp`
  ...
  - [x] 1.1 Definir a arvore inicial de modulos em `packages/hardless-mcp/src/`
  ...
  - [x] 1.2 Modelar tipos centrais do alpha
  ...
  - [x] 1.3 Definir constantes de schema e paths de `.hardless/`
...
- [x] 3. Implementar discovery e snapshots de fontes
  ...
  - [x] 3.1 Implementar mapa inicial de discovery suportado
  ...
  - [x] 3.2 Implementar hashing e snapshot store
  ...
  - [x] 3.3 Cobrir falhas de leitura e workspace invalido
...
- [x] 4. Implementar fragmentacao e classificacao inicial
  ...
  - [x] 4.1 Implementar heuristicas deterministicas de fragmentacao
  ...
  - [x] 4.2 Implementar classificacao por tema operacional e task type
  ...
  - [x] 4.3 Persistir manifestos de fragmentos e proveniencia
...
- [x] 5. Checkpoint de bootstrap intermediario
...
- [x] 6. Gerar artefatos curados e manifests operacionais
  ...
  - [x] 6.1 Implementar writers de `workspace.json`, `sources.json`, `fragments.json`, `routing.json` e `provenance.json`
  ...
  - [x] 6.2 Implementar avaliacao de confianca e ativacao condicional
  ...
  - [x] 6.3 Gerar rule bundles required, triggered e fallback
  ...
  - [x] 6.4 Gerar indexes por task type e referencias sob gatilho
  ...
  - [x] 6.5 Gerar `bootstrap-summary.md`
...
- [x] 7. Implementar runtime de triagem e carregamento minimo
  ...
  - [x] 7.1 Implementar classificador de triagem
  ...
  - [x] 7.2 Implementar loader de contexto minimo
  ...
  - [x] 7.3 Implementar plano curto prescritivo para `fast_mode`
  ...
  - [x] 7.4 Implementar promocao de `fast_mode` para `spec_flow`
  ...
  - [x] 7.5 Implementar gates universais de escrita e validacao
...
- [x] 8. Implementar drift detection e reconciliacao incremental
  ...
  - [x] 8.3 Implementar refresh parcial com degradacao explicita
...
- [-] 10. Expor tools MCP do alpha
  ...
  - [x] 10.0 Integrar SDK MCP por tras de adapter interno
  ...
  - [x] 10.1 Implementar tool `hardless.bootstrap`
  ...
  - [x] 10.2 Implementar tool `hardless.refresh`
  ...
  - [x] 10.3 Implementar tool `hardless.triage`
  ...
  - [x] 10.4 Implementar tool `hardless.context`
  ...
  - [x] 10.5 Implementar tool `hardless.status`
...
- [x] 11. Validacao final e sync de artefatos
  ...
  - [x] 11.1 Adicionar fixtures e testes direcionados do alpha
  ...
  - [x] 11.2 Executar validacoes de build e typecheck
  ...
  - [x] 11.3 Sincronizar `requirements.md`, `design.md`, `tasks.md` e `decisions.md` se a execucao mudar contratos
